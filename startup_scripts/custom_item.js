...
onEvent('item.registry', event => {
	...
	event.create('okara')                       .displayName('Okara')        .food(food=>{food.hunger(4).saturation(1)})
	event.create('soy_curds')                   .displayName('Soy Curds')    .food(food=>{food.hunger(4).saturation(0)})
	event.create('firm_tofu')                   .displayName('Firm Tofu Brick')        .food(food=>{food.hunger(8).saturation(2)})
	event.create('firm_tofu_chunk')             .displayName('Firm Tofu Chunk')        .food(food=>{food.hunger(4).saturation(1)})
	event.create('silken_tofu')                 .displayName('Silken Tofu Brick')      .food(food=>{food.hunger(8).saturation(1)})
	event.create('silken_tofu_chunk')           .displayName('Silken Tofu Chunk')      .food(food=>{food.hunger(4).saturation(1)})
	// long stick
