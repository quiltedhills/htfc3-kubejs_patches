...
onEvent('item.registry', event => {
	...
	event.create('chisel_stone_head')			.displayName('Stone Chisel Head')
	event.create('chisel_iron_head')			.displayName('Iron Chisel Head')
	event.create('chisel_rose_gold_head')		.displayName('Rose Gold Chisel Head')
	event.create('chisel_blue_steel_head')		.displayName('Blue Steel Chisel Head')
	event.create('chisel_compressed_iron_head')	.displayName('Compressed Iron Chisel Head')
