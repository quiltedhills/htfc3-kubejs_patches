...
<recipetype:mekanism:washing>.addRecipe("cleaning_uranium_slurry", FluidStackIngredient.from(<tag:fluids:minecraft:waters>, 10), SlurryStackIngredient.from(<slurry:mekanism:dirty_uranium>), <slurry:mekanism:clean_uranium>);
